  ...
  return (
    <div className="max-w-sm mx-auto px-4 py-16">
      ...
      <button
        ...
        className="w-full py-3 border border-gray-200 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 mb-6"
      >
      ...
      <div className="relative mb-6">
        ...
        <div className="relative text-center">
          <span className="bg-gray-50 px-3 text-xs text-gray-400">or email</span>
        </div>
      </div>
